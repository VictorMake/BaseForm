...
Partial Class FormCalculatedParameters
    ...
    Private Sub InitializeComponent()
        ...
        Me.CalculatedParametersTableAdapter = New BaseForm.BaseFormDataSetTableAdapters.РасчетныеПараметрыTableAdapter()
    ...
    Friend WithEvents BaseFormDataSet As BaseForm.BaseFormDataSet
    Friend WithEvents РасчетныеПараметрыBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents CalculatedParametersTableAdapter As BaseForm.BaseFormDataSetTableAdapters.РасчетныеПараметрыTableAdapter
