...
Partial Class FormMeasurementParameters
    ...
    Private Sub InitializeComponent()
        ...
        Me.MeasurementParametersTableAdapter = New BaseForm.BaseFormDataSetTableAdapters.ИзмеренныеПараметрыTableAdapter()
        ...
        Me.РазмерностьВходнаяDataGridViewTextBoxColumn.HeaderText = "Ед. изм. входная"
    ...
    Public WithEvents MeasurementParametersTableAdapter As BaseForm.BaseFormDataSetTableAdapters.ИзмеренныеПараметрыTableAdapter
